...
const HeaderComponent = ({ isHiddenSearch = false, isHiddenCart = false }) => {
  ...
  return (
    <div style={{  heiht: '100%', width: '100%', display: 'flex',background: '#127871', justifyContent: 'center' }}>
      <WrapperHeader style={{ justifyContent: isHiddenSearch && isHiddenSearch ? 'space-between' : 'unset' }}>
        <Col span={5}>
          <WrapperTextHeader to='/'><img src='https://cdn.discordapp.com/attachments/1086244555227152397/1148509943645863957/Green_Leaf_Home_Agriculture_Logo.png' style={{ height: '70px', width: '80px'}}></img></WrapperTextHeader>
        </Col>
        {!isHiddenSearch && (
          <Col span={13}>
            <ButttonInputSearch
